        ...
        <div className="container-fluid py-5">
            ...
            <div className="row">
                ...
                <div className="mb-5">
                    ...
                    <img className="img-fluid rounded w-50 float-right ml-4 mb-3" src="img/blog-2.jpg" alt="Image" />
                    <p>Diam dolor est labore duo invidunt ipsum clita et, sed et lorem voluptua tempor invidunt at
                    est
                    sanctus sanctus. Clita dolores sit kasd diam takimata justo diam lorem sed. Magna amet sed
                    rebum
                ...
                <div className="mb-5">
                    ...
                    <img className="img-fluid rounded" src="img/blog-1.jpg" style={{width: 80, height: 80, objectFit: 'cover'}} alt />
                    ...
                    <div className="d-flex align-items-center border-bottom mb-3 pb-3">
                    <img className="img-fluid rounded" src="img/blog-2.jpg" style={{width: 80, height: 80, objectFit: 'cover'}} alt />
                    <div className="d-flex flex-column pl-3">
                        <a className="text-dark mb-2" href>Elitr diam amet sit elitr magna ipsum ipsum dolor</a>
                        <div className="d-flex">
                        <small><a className="text-secondary text-uppercase font-weight-medium" href>Admin</a></small>
                    ...
                    <div className="d-flex align-items-center border-bottom mb-3 pb-3">
                    <img className="img-fluid rounded" src="img/blog-3.jpg" style={{width: 80, height: 80, objectFit: 'cover'}} alt />
                    <div className="d-flex flex-column pl-3">
                        <a className="text-dark mb-2" href>Elitr diam amet sit elitr magna ipsum ipsum dolor</a>
                        <div className="d-flex">
                        <small><a className="text-secondary text-uppercase font-weight-medium" href>Admin</a></small>
